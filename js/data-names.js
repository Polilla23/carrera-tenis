...
(function(){
  ...
  TC.ITF_CITIES = ['Villa Maria','Junin','Bauru','Temuco','Cochabamba','Asuncion','Manacor','Antalya','Monastir','Sharm El Sheikh','Kazan','Vilnius','Tallin','Oslo','Helsinki','Jakarta','Nonthaburi','Cancun','Santo Domingo','Naples FL','Orange Park','Edmonton','Traralgon','Mildura','Hua Hin','Colombo','Nairobi','Tunez','Rabat','Luanda','Heraklion','Kigali','Nakhon Si Thammarat','Nueva Delhi','Anseong','Wellington','Trelew','Guatemala'];
  TC.ITF_REGIONS = ['sam','sam','sam','sam','sam','sam','eur','eur','afr','afr','eur','eur','eur','eur','eur','asia','asia','nam','nam','nam','nam','nam','oce','oce','asia','asia','afr','afr','afr','afr','eur','afr','asia','asia','asia','oce','sam','nam'];
  // superficie real de cada sede ITF
  TC.ITF_SURFS = ['clay','clay','clay','clay','clay','clay','hard','clay','hard','hard','indoor','indoor','indoor','indoor','indoor','hard','hard','hard','hard','clay','clay','indoor','hard','grass','hard','clay','clay','clay','clay','hard','hard','clay','hard','hard','hard','hard','clay','hard'];
})();
